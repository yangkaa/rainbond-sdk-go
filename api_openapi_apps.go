...
*/
func (a *OpenapiAppsApiService) TeamsRegionsAppsMonitorQueryList(ctx _context.Context, regionName string, teamId string, appId int32) ([]ComponentMonitorSerializers, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
