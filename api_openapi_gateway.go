...
func (a *OpenapiGatewayApiService) TeamsRegionsAppsDomainsDelete(ctx _context.Context, appId string, regionName string, ruleId string, teamId string) (HttpGatewayRule, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/openapi/v1/teams/{team_id}/regions/{region_name}/apps/{app_id}/domains/{rule_id}"
...
@return HttpGatewayRule
*/
func (a *OpenapiGatewayApiService) TeamsRegionsAppsHttpdomainsCreate(ctx _context.Context, regionName string, teamId string, appId int32, data PostHttpGatewayRule) (HttpGatewayRule, *_nethttp.Response, error) {
	var (
